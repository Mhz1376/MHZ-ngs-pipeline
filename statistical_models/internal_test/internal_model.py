...
plt.title('Top Genes by Normalized Weighted Score', fontsize=16, fontweight='bold')
...
plt.title('Gene Importance Across Files', fontsize=16, fontweight='bold')
...
plt.title('Histogram of Normalized Weighted Scores', fontsize=16, fontweight='bold')
plt.xlabel('Normalized Weighted Score', fontsize=14)
...
plt.title('Box Plot of Normalized Weighted Scores', fontsize=16, fontweight='bold')
plt.xlabel('Normalized Weighted Score', fontsize=14)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.grid(True, linestyle='--', alpha=0.7)
...
plt.title('Violin Plot of Normalized Weighted Scores', fontsize=16, fontweight='bold')
...
plt.title('Clustered Heatmap of Gene Statistics', fontsize=16, fontweight='bold')
plt.tight_layout()
